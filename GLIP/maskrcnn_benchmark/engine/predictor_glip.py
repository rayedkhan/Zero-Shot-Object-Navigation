...
class GLIPDemo(object):
    ...
    def run_ner(self, caption):
        ...
        if 'candle' in caption.lower() and 'rice cooker' not in caption.lower():
            noun_phrases = ['bed', 'book', 'bottle', 'box', 'knife', 'candle', 'cd', 'cellphone', 'chair', 'cup', 'desk', 'table', 'drawer', 'dresser', 'lamp', 'fork', 'newspaper', 'painting', 'pencil', 'pepper shaker', 'pillow', 'plate', 'pot', 'salt shaker', 'shelf', 'sofa', 'statue', 'tennis racket', 'tv stand', 'watch', 'clock', 'apple', 'baseball bat', 'basketball', 'bowl', 'garbage can', 'plant', 'laptop', 'mug', 'remotecontrol', 'spray bottle', 'television', 'vase', 'wall']
        if 'room' in caption.lower():
        ...
        assert len(tokens_positive) == len(noun_phrases)
