...
class RobothorChallenge:
    ...
    def __init__(self, cfg_file, agent_class, agent_kwargs, experiment_name, env_type, class_type, render_depth=False, render_segmentation=False, class_remap=None, seed=0):
    ...
    def inference_worker(
        ...
        controller = ai2thor.controller.Controller(depth_frame=True, **controller_kwargs)
        ...
        while True:
            ...
            if class_remap is not None:
                print("remapping")
                agent.remap_classes(class_remap[e["scene"]])
            if(env_type == EnvTypes.LONGTAIL):
                print("remapping")
                agent.remap_longtail()
            ...
            while total_steps < max_steps and stopped is False:
                ...
                print("step ", total_steps, " with action ", action)
